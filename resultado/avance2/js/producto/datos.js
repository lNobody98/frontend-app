...
//  - Constructor           → new Producto(...) / new Servicio(...)
...
//  Copia una línea existente y ajusta los argumentos según el tipo.
//
//    new Producto(
...
//      subcategoria, → ver lista de subcategorías válidas más abajo
//      precio,       → entero en soles. Usar 0 para "Gratis"
//      proveedor,    → empresa que brinda el servicio (ej: "NXR TECH")
//      modalidad,    → "Presencial" | "Remota" | "Mixta"
//      descripcion,  → texto corto para la card
//      imagen        → ruta relativa a la imagen.
//    )
//
...
const listaProductos = [
    ...
    // ── Soporte (6) ─────────────────────────────────────────
    new Servicio(61, "Soporte Técnico Básico", "Soporte", 150, "NXR TECH", "Mixta", "Diagnóstico y resolución de problemas de software y hardware en el local.", "../../img/catalogo/servicios/s-01.jpg"),
    new Servicio(62, "Soporte Remoto 24/7", "Soporte", 199, "NXR TECH", "Remota", "Asistencia técnica remota las 24 horas del día, los 7 días a la semana.", "../../img/catalogo/servicios/s-02.jpg"),
    new Servicio(63, "Diagnóstico Gratuito", "Soporte", 0, "NXR TECH", "Mixta", "Evaluación inicial completa de tu equipo sin costo. Solo pagas si reparas.", "../../img/catalogo/servicios/s-03.jpg"),
    new Servicio(64, "Soporte Premium Mensual", "Soporte", 299, "NXR TECH", "Mixta", "Plan mensual con prioridad de atención, visitas ilimitadas y descuentos.", "../../img/catalogo/servicios/s-16.jpg"),
    new Servicio(65, "Soporte Empresarial", "Soporte", 899, "NXR TECH", "Mixta", "Contrato corporativo para empresas: SLA 4 h, técnico asignado, informes.", "../../img/catalogo/servicios/s-17.jpg"),
    new Servicio(66, "Soporte en Domicilio", "Soporte", 180, "NXR TECH", "Mixta", "Visita técnica a tu hogar u oficina para resolver problemas in situ.", "../../img/catalogo/servicios/s-18.jpg"),

    // ── Mantenimiento (6) ───────────────────────────────────
    new Servicio(67, "Limpieza Interna de Laptop", "Mantenimiento", 80, "NXR TECH", "Presencial", "Limpieza profunda de componentes internos, pasta térmica y ventiladores.", "../../img/catalogo/servicios/s-04.jpg"),
    new Servicio(68, "Mantenimiento Preventivo", "Mantenimiento", 120, "NXR TECH", "Presencial", "Revisión periódica completa: sistema, hardware, drivers y actualizaciones.", "../../img/catalogo/servicios/s-05.jpg"),
    new Servicio(69, "Cambio de Pasta Térmica", "Mantenimiento", 60, "NXR TECH", "Presencial", "Reemplazo de pasta térmica para reducir temperaturas y mejorar rendimiento.", "../../img/catalogo/servicios/s-06.jpg"),
    new Servicio(70, "Revisión de Batería", "Mantenimiento", 70, "NXR TECH", "Presencial", "Análisis de ciclos de carga y diagnóstico de batería en laptops y móviles.", "../../img/catalogo/servicios/s-19.jpg"),
    new Servicio(71, "Actualización de Firmware", "Mantenimiento", 90, "NXR TECH", "Presencial", "Actualización de BIOS, firmware de SSD y drivers críticos de seguridad.", "../../img/catalogo/servicios/s-20.jpg"),
    new Servicio(72, "Mantenimiento PC Escritorio", "Mantenimiento", 100, "NXR TECH", "Presencial", "Limpieza completa, revisión de conexiones y optimización de PC de escritorio.", "../../img/catalogo/servicios/s-21.jpg"),

    // ── Reparación (6) ──────────────────────────────────────
    new Servicio(73, "Cambio de Pantalla", "Reparación", 250, "NXR TECH", "Mixta", "Reemplazo de pantalla rota o con fallas para laptops y smartphones.", "../../img/catalogo/servicios/s-07.jpg"),
    new Servicio(74, "Reparación de Teclado", "Reparación", 180, "NXR TECH", "Mixta", "Reparación o sustitución de teclado dañado en laptops de cualquier marca.", "../../img/catalogo/servicios/s-08.jpg"),
    new Servicio(75, "Recuperación de Datos", "Reparación", 350, "NXR TECH", "Mixta", "Recuperamos archivos de discos dañados, formateados o con fallas críticas.", "../../img/catalogo/servicios/s-09.jpg"),
    new Servicio(76, "Cambio de Batería", "Reparación", 150, "NXR TECH", "Mixta", "Sustitución de batería degradada en laptops, smartphones y tablets.", "../../img/catalogo/servicios/s-22.jpg"),
    new Servicio(77, "Reparación de Puerto USB/C", "Reparación", 200, "NXR TECH", "Mixta", "Soldadura y reemplazo de puertos USB, USB-C y HDMI dañados.", "../../img/catalogo/servicios/s-23.jpg"),
    new Servicio(78, "Reparación de Placa Madre", "Reparación", 450, "NXR TECH", "Mixta", "Diagnóstico y reparación a nivel de componentes en placa madre.", "../../img/catalogo/servicios/s-24.jpg"),

    // ── Instalación (6) ─────────────────────────────────────
    new Servicio(79, "Instalación de Sistema Operativo", "Instalación", 90, "NXR TECH", "Mixta", "Instalación y configuración de Windows, macOS o Linux con drivers.", "../../img/catalogo/servicios/s-10.jpg"),
    new Servicio(80, "Configuración de Red", "Instalación", 120, "NXR TECH", "Mixta", "Configuración de redes LAN/WiFi, routers, switches y puntos de acceso.", "../../img/catalogo/servicios/s-11.jpg"),
    new Servicio(81, "Instalación de Software", "Instalación", 70, "NXR TECH", "Remota", "Instalación de paquetes de software para trabajo o estudio.", "../../img/catalogo/servicios/s-12.jpg"),
    new Servicio(82, "Migración de Datos", "Instalación", 160, "NXR TECH", "Mixta", "Traslado seguro de archivos, aplicaciones y configuraciones entre equipos.", "../../img/catalogo/servicios/s-25.jpg"),
    new Servicio(83, "Instalación de Antivirus", "Instalación", 80, "NXR TECH", "Mixta", "Configuración de solución antivirus y antimalware con monitoreo activo.", "../../img/catalogo/servicios/s-26.jpg"),
    new Servicio(84, "Instalación de Cámaras IP", "Instalación", 350, "NXR TECH", "Mixta", "Instalación y configuración de sistema de cámaras de seguridad IP.", "../../img/catalogo/servicios/s-27.jpg"),

    // ── Asesoría (6) ────────────────────────────────────────
    new Servicio(85, "Asesoría de Compra", "Asesoría", 50, "NXR TECH", "Mixta", "Te ayudamos a elegir el equipo ideal según tu presupuesto y necesidades.", "../../img/catalogo/servicios/s-13.jpg"),
    new Servicio(86, "Consultoría TI para Empresas", "Asesoría", 400, "NXR TECH", "Mixta", "Evaluación y optimización de infraestructura tecnológica para empresas.", "../../img/catalogo/servicios/s-14.jpg"),
    new Servicio(87, "Capacitación Técnica", "Asesoría", 200, "NXR TECH", "Mixta", "Cursos básicos de uso, mantenimiento y seguridad informática.", "../../img/catalogo/servicios/s-15.jpg"),
    new Servicio(88, "Asesoría de Seguridad", "Asesoría", 180, "NXR TECH", "Mixta", "Evaluación de riesgos y recomendaciones de seguridad para tu entorno digital.", "../../img/catalogo/servicios/s-28.jpg"),
    new Servicio(89, "Plan Tecnológico Empresarial", "Asesoría", 600, "NXR TECH", "Mixta", "Diseño de hoja de ruta tecnológica alineada a los objetivos del negocio.", "../../img/catalogo/servicios/s-29.jpg"),
    new Servicio(90, "Evaluación de Hardware", "Asesoría", 120, "NXR TECH", "Mixta", "Análisis del estado y vida útil de todos los equipos de tu empresa.", "../../img/catalogo/servicios/s-30.jpg"),

    // ── Ciberseguridad (6) ──────────────────────────────────
    new Servicio(91, "Análisis de Vulnerabilidades", "Ciberseguridad", 500, "NXR TECH", "Mixta", "Escaneo completo de la red y sistemas en busca de vulnerabilidades activas.", "../../img/catalogo/servicios/ciberseg.jpg"),
    new Servicio(92, "Instalación de Firewall", "Ciberseguridad", 350, "NXR TECH", "Mixta", "Configuración de firewall perimetral para protección avanzada de la red.", "../../img/catalogo/servicios/s-31.jpg"),
    new Servicio(93, "Auditoría de Seguridad", "Ciberseguridad", 800, "NXR TECH", "Mixta", "Revisión integral de políticas, controles y accesos de seguridad informática.", "../../img/catalogo/servicios/s-32.jpg"),
    new Servicio(94, "Pen Testing Básico", "Ciberseguridad", 1200, "NXR TECH", "Mixta", "Prueba de penetración ética para detectar brechas antes que los atacantes.", "../../img/catalogo/servicios/s-33.jpg"),
    new Servicio(95, "Configuración VPN Empresarial", "Ciberseguridad", 450, "NXR TECH", "Remota", "Implementación de VPN segura para trabajo remoto con acceso cifrado.", "../../img/catalogo/servicios/s-34.jpg"),
    new Servicio(96, "Capacitación Anti-Phishing", "Ciberseguridad", 300, "NXR TECH", "Mixta", "Taller para equipos de trabajo sobre amenazas de phishing y buenas prácticas.", "../../img/catalogo/servicios/s-35.jpg"),

    // ── Diseño Digital (6) ──────────────────────────────────
    new Servicio(97, "Diseño de Logo", "Diseño Digital", 400, "NXR TECH", "Mixta", "Creación de logotipo profesional con 3 propuestas y archivos editables.", "../../img/catalogo/servicios/diseno.jpg"),
    new Servicio(98, "Diseño Web Básico", "Diseño Digital", 800, "NXR TECH", "Remota", "Landing page de 1 página, responsive, con formulario de contacto.", "../../img/catalogo/servicios/s-36.jpg"),
    new Servicio(99, "Diseño de Presentaciones", "Diseño Digital", 250, "NXR TECH", "Mixta", "Presentación corporativa en PowerPoint o Google Slides, máximo 20 diapositivas.", "../../img/catalogo/servicios/s-37.jpg"),
    new Servicio(100, "Diseño de Banners Digitales", "Diseño Digital", 180, "NXR TECH", "Mixta", "Pack de 5 banners para redes sociales en formato estático o animado.", "../../img/catalogo/servicios/s-38.jpg"),
    new Servicio(101, "Identidad Visual Corporativa", "Diseño Digital", 1200, "NXR TECH", "Mixta", "Manual de marca completo: logo, colores, tipografías, aplicaciones.", "../../img/catalogo/servicios/s-39.jpg"),
    new Servicio(102, "Edición de Video Básica", "Diseño Digital", 350, "NXR TECH", "Mixta", "Edición de video corporativo o publicitario de hasta 2 minutos.", "../../img/catalogo/servicios/s-40.jpg"),

    // ── Networking (6) ──────────────────────────────────────
    new Servicio(103, "Cableado Estructurado", "Networking", 1500, "NXR TECH", "Presencial", "Instalación de cableado de red Cat6/Cat6A para oficinas y empresas.", "../../img/catalogo/servicios/networking.jpg"),
    new Servicio(104, "Configuración de Switches", "Networking", 400, "NXR TECH", "Presencial", "Configuración de switches administrables con VLANs y QoS.", "../../img/catalogo/servicios/s-41.jpg"),
    new Servicio(105, "Monitoreo de Red", "Networking", 350, "NXR TECH", "Presencial", "Implementación de solución de monitoreo 24/7 con alertas y reportes.", "../../img/catalogo/servicios/s-42.jpg"),
    new Servicio(106, "WiFi Empresarial", "Networking", 800, "NXR TECH", "Presencial", "Diseño e instalación de red WiFi empresarial con puntos de acceso gestionados.", "../../img/catalogo/servicios/s-43.jpg"),
    new Servicio(107, "Segmentación de Red", "Networking", 500, "NXR TECH", "Presencial", "División de la red en segmentos seguros mediante VLANs y ACLs.", "../../img/catalogo/servicios/s-44.jpg"),
    new Servicio(108, "Auditoría de Red", "Networking", 600, "NXR TECH", "Presencial", "Análisis completo del rendimiento, seguridad y topología de la red.", "../../img/catalogo/servicios/s-45.jpg"),

    // ── Cloud & Backup (6) ──────────────────────────────────
    new Servicio(109, "Migración a la Nube", "Cloud & Backup", 1200, "NXR TECH", "Remota", "Traslado de servidores y datos on-premise a plataformas cloud (AWS, Azure, GCP).", "../../img/catalogo/servicios/cloud.jpg"),
    new Servicio(110, "Backup Automático", "Cloud & Backup", 300, "NXR TECH", "Remota", "Configuración de copias de seguridad automáticas en la nube con retención 30 días.", "../../img/catalogo/servicios/s-46.jpg"),
    new Servicio(111, "Sincronización de Dispositivos", "Cloud & Backup", 180, "NXR TECH", "Mixta", "Configuración de sincronización entre equipos y servicios en la nube.", "../../img/catalogo/servicios/s-47.jpg"),
    new Servicio(112, "Disaster Recovery", "Cloud & Backup", 1800, "NXR TECH", "Mixta", "Plan de recuperación ante desastres con RTO y RPO definidos.", "../../img/catalogo/servicios/s-48.jpg"),
    new Servicio(113, "Almacenamiento en la Nube", "Cloud & Backup", 150, "NXR TECH", "Remota", "Configuración y gestión de almacenamiento en la nube para equipos de trabajo.", "../../img/catalogo/servicios/s-49.jpg"),
    new Servicio(114, "Monitoreo de Infraestructura", "Cloud & Backup", 500, "NXR TECH", "Mixta", "Supervisión continua de servidores y servicios cloud con alertas en tiempo real.", "../../img/catalogo/servicios/s-50.jpg"),

    // ── Desarrollo Web (6) ──────────────────────────────────
    new Servicio(115, "Landing Page", "Desarrollo Web", 600, "NXR TECH", "Mixta", "Página de aterrizaje optimizada para conversión, responsive y rápida.", "../../img/catalogo/servicios/desarrollo.jpg"),
    new Servicio(116, "Tienda Virtual Básica", "Desarrollo Web", 2500, "NXR TECH", "Mixta", "E-commerce con hasta 50 productos, carrito, pasarela de pago y panel admin.", "../../img/catalogo/servicios/s-51.jpg"),
    new Servicio(117, "Mantenimiento Web Mensual", "Desarrollo Web", 300, "NXR TECH", "Remota", "Actualizaciones, copias de seguridad, soporte y mejoras mensuales del sitio.", "../../img/catalogo/servicios/s-52.jpg"),
    new Servicio(118, "Web App Básica", "Desarrollo Web", 3500, "NXR TECH", "Remota", "Aplicación web a medida con base de datos, autenticación y panel de administración.", "../../img/catalogo/servicios/s-53.jpg"),
    new Servicio(119, "Optimización SEO", "Desarrollo Web", 400, "NXR TECH", "Remota", "Auditoría y optimización técnica y de contenido para mejora en buscadores.", "../../img/catalogo/servicios/s-54.jpg"),
    new Servicio(120, "Integración de Pasarela de Pago", "Desarrollo Web", 700, "NXR TECH", "Remota", "Integración de Culqi, Mercado Pago, PayPal o Stripe en sitios existentes.", "../../img/catalogo/servicios/s-55.jpg"),
];
